...
def main():
    ...
    if classifier == 'Support Vector Machine (SVM)':
        ...
        if st.sidebar.button("Classify", key="Classify"):
            ...
            st.write("Precision:", precision_score(y_test, y_pred, pos_label=1).round(2))  # Use pos_label=1 if '1' is the positive class
            st.write("Recall:", recall_score(y_test, y_pred, pos_label=1).round(2))  # Use pos_label=1 if '1' is the positive class
